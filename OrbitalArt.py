    ...
    while paused:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                elif event.key == pygame.K_ESCAPE: pygame.quit()
...
class Block:
    ...
    def calculateVel(a,b):
        ...
        v2 = b.vel.mag()
        O2 = atan2(b.vel.y,b.vel.x)
        m2 = b.mass

        cpy = ((a.pos.y * b.r) + (b.pos.y * a.r)) / (a.r + b.r)
        cpx = ((a.pos.x * b.r) + (b.pos.x * a.r)) / (a.r + b.r)
        phi = atan2(a.pos.y - cpy, a.pos.x - cpx)

        vx = (((v1 * cos(O1 - phi) * (m1 - m2)) + (2 * m2 * v2 * cos(O2 - phi))) / (m1 - m2)) * cos(phi) + v1 * sin(O1 - phi) * cos(phi + pi/2)
...
def bounce(a,b):
    ...
    if (d > (a.r + b.r)):
        ...
        x,y = b.pos.y - a.pos.y, b.pos.x - a.pos.x
        ...
        if not a.immobile: a_new_vel = Block.calculateVel(a, b)
        if not b.immobile: b_new_vel = Block.calculateVel(b, a)
